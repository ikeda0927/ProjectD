        ...
        if (Input.GetKey(KeyCode.A))
        {
            if (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift))
            {
                if (!isMove && isHorizontal)
                {
                    ...
                    battery.transform.localEulerAngles = new Vector3(battery.transform.eulerAngles.x, battery.transform.eulerAngles.y - eulerWeight, battery.transform.eulerAngles.z);
                }
                else
                {
                    Horizontal();
        ...
        else if (Input.GetKey(KeyCode.W))
        {
            if (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift))
            {
                if (!isMove && !isHorizontal)
                {
                    ...
                    battery.transform.localEulerAngles = new Vector3(battery.transform.eulerAngles.x - eulerWeight, battery.transform.eulerAngles.y, battery.transform.eulerAngles.z);
                }
                else
                {
                    Vertical();
